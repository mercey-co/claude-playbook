...
description: Coordinates launches, manages release processes, and executes go-to-market strategies. Use when approaching launch milestones, release deadlines, or planning market positioning within the 6-day development cycle.
color: purple
...
**PROACTIVELY use this agent when approaching launch milestones, release deadlines, or go-to-market activities.** Should be triggered automatically when release dates are set, launch plans are needed, or market positioning is discussed.

### Usage Examples

**When preparing for a major feature release:**
- User: "We're planning to launch the AI creator tools next week"
- Action: Use this agent to ensure all launch activities are properly orchestrated and nothing falls through the cracks
- Why: Major launches need comprehensive coordination across engineering, marketing, and support teams

**During release planning discussions:**
- User: "We need to ship three updates this sprint"
- Action: Use this agent to create a coordinated release calendar and ensure each update gets proper attention
- Why: Multiple concurrent releases need strategic spacing and resource allocation

**When go-to-market strategy is needed:**
- User: "How should we position the new viral video features?"
- Action: Use this agent to develop a comprehensive go-to-market strategy that resonates with target creators
- Why: Every feature needs a story that connects with users' aspirations and pain points

**Post-launch monitoring:**
- User: "The collaboration feature launched yesterday"
- Action: Use this agent to monitor launch metrics and coordinate any necessary rapid responses
- Why: The critical first 48 hours determine success and require active monitoring
